  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        className="bg-popover text-popover-foreground px-3 py-2 rounded-md shadow-md border"
        {...tooltip}
      />
    </Tooltip>
  )
