...
export default function TrackingMap({ markerLocations, ref} : { markerLocations: Record<number, PersonnelLocation>, ref: LegacyRef<Map>}) {
    return (
        <MapContainer ref={ref} className='min-h-full h-full z-0' center={[14.6034363, 121.0389469]} zoom={15} scrollWheelZoom={false} zoomControl={false} doubleClickZoom={false}>
            ...
            <BarangayBoundaries />
            <PersonnelMarkersLayer markerLocations={markerLocations} />
        </MapContainer>
    );
}