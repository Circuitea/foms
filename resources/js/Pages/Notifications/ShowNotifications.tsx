    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="sticky top-0 z-50 bg-[#1B2560] px-4 md:px-6 py-4 shadow-lg">
          ...
          <div className="mt-2 text-sm text-gray-300">CDRRMO Staff Portal › Internal Notifications › Task Details</div>
        </div>
        ...
        <div className="py-6">
          <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <button
                onClick={handleBackToNotifications}
                className="mt-4 px-4 py-2 bg-[#1B2560] text-white rounded hover:bg-[#1B2560]/90"
              >
                Back to Notifications
              </button>
            </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-50 bg-[#1B2560] px-4 md:px-6 py-4 shadow-lg">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="text-right">
            <div className="text-sm text-white">Notification Details</div>
            <div className="text-sm font-mono text-white">{currentDateTime}</div>
          </div>
        </div>
        <div className="mt-2 text-sm text-gray-300">CDRRMO Staff Portal › Internal Notifications › Task Details</div>
