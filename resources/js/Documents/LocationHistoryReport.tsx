...
export function LocationHistoryReport({ personnel, date, creator }: { personnel: PersonnelWithLocationHistory[], date: Date, creator: Personnel }) {
  ...
  return (
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={{ marginBottom: 8 }}>This is a generated report based on the real-time duty monitoring system of the San Juan CDRRMO. The table below are the personnel who are subject to this report on the date of {dayjs(date).format('MMMM DD, YYYY')}.</Text>
