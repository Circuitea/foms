...
Generated by: CDRRMO Task Management System
    ...
    a.href = url
    a.download = `CDRRMO_Task_Report_${task.id}_${new Date().toISOString().split("T")[0]}.txt`
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        ...
                        style={{ backgroundColor: task.priority === "normal" ? "#1B2560" : undefined }}
                      >
        ...
        {templates.map((template) => (
          <div key={template.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-3">
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium border ${getPriorityColor(template.priority)}`}
                style={{ backgroundColor: template.priority === "normal" ? "#1B2560" : undefined }}
              >
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">CDRRMO Operations Center</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-4">
                <div className="flex items-center gap-3 mb-3">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium border ${getPriorityColor(selectedTask.priority)}`}
                    style={{ backgroundColor: selectedTask.priority === "normal" ? "#1B2560" : undefined }}
                  >
